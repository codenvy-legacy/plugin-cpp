...
@Singleton
public class CPPPagePresenter extends AbstractWizardPage implements CPPPageView.ActionDelegate {

    private CPPPageView            view;
    ...
    @Inject
    public CPPPagePresenter(CPPPageView view, ProjectServiceClient projectServiceClient, EventBus eventBus, DtoFactory dtoFactory,
                            DtoUnmarshallerFactory dtoUnmarshallerFactory) {
        super("C++ project settings", null);
        this.view = view;
    ...
    public void commit(@NotNull final CommitCallback callback) {
        ...
        projectDescriptorToUpdate.setRunner(ProjectAttributes.CPP_DEFAULT_RUNNER);
        projectDescriptorToUpdate.setDefaultRunnerEnvironment(ProjectAttributes.CPP_DEFAULT_RUNNER_ENVID);
